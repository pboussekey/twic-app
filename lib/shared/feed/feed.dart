...
class Feed extends StatefulWidget {
  ...
  Feed({this.hashtag_id, this.user_id, this.hideHeaders = false, this.placeholder, this.school_id});
...
class FeedState extends State<Feed> {
  ...
  @override
  Widget build(BuildContext context) => posts.length > 0 || null == widget.placeholder || !initialized  ? InfiniteScroll(
    fetch: _fetch,
