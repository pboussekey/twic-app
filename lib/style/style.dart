...
abstract class Style {
  ...
  static TextStyle placeholder =
      TextStyle(fontSize: 17.0, color: Style.lightGrey, fontFamily: 'Rubik');
  ...
  static TextStyle greyText =
      TextStyle(fontSize: 15.0, color: Style.grey, fontFamily: 'Rubik');
  static TextStyle whiteText =
      TextStyle(fontSize: 14.0, color: Colors.white, fontFamily: 'Rubik');
  static TextStyle redText =
      TextStyle(fontSize: 14.0, color: Style.red, fontFamily: 'Rubik');
  static TextStyle text =
      TextStyle(fontSize: 14.0, color: Style.darkGrey, fontFamily: 'Rubik');
  ...
  static TextStyle smallText =
      TextStyle(fontSize: 12.0, color: Style.darkGrey, fontFamily: 'Rubik');
  ...
  static TextStyle hashtagStyle =
      TextStyle(fontSize: 15.0, color: Style.mainColor, fontFamily: 'Rubik');
